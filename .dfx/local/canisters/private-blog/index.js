...
import { idlFactory } from './private-blog.did.js';
export { idlFactory } from './private-blog.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PRIVATE-BLOG_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./private-blog.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the private-blog canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./private-blog.did.js")._SERVICE>}
 */
export const private-blog = createActor(canisterId);
